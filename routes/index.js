...
router.get("/admin", authController.isAdminLoggedIn, pageController.adminPage);
...
router.post(
  ...
  catchErrors(pageController.contactPageForm)
);
router.post(
  "/product-enquire/success",
...
router.get(
  "/stock1234/products/page/:page",
  catchErrors(productController.getProducts)
);
router.get(
  "/stock1234/products/c/:category",
  catchErrors(productController.getProductsByCategory)
);
router.get(
  "/stock1234/products/:tags",
  catchErrors(productController.getProductsByTagFilter)
);
router.get(
  "/admin/add-product",
...
router.get(
  "/stock1234/products/:id/edit",
  catchErrors(productController.editProduct)
);
router.get(
  "/stock1234/product/:slug",
...
router.get(
  "/categories/:id/edit",
  catchErrors(categoryController.editCategory)
);
router.post(
...
router.post("/admin/add-tag/:id", catchErrors(tagController.updateTag));
...
router.get(
  "/tag-parents/:id/edit",
  catchErrors(tagParentController.editTagParent)
);
router.post(
  "/admin/add-parent-tag/:id",
  catchErrors(tagParentController.updateTagParent)
);
router.get(
  "/tag-parent/:id/delete",
  catchErrors(tagParentController.deleteTagParent)
);
...
router.post("/admin/account", catchErrors(userController.updateAccount));
