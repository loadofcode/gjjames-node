...
function searchFilters() {
  var newHash = void 0;
  var baseUrl = "https://gjjames.co.uk";
...
function typeAheadHome(search) {
  ...
  var searchInput = search.querySelector('input[name="hero-search"]');
  var searchResults = search.querySelector('.search__hero-results');
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
      ...
      // nothign came back
      searchResults.innerHTML = _dompurify2.default.sanitize('<div class="search__result-hero">No results for <strong>' + _this.value + '</strong> found!</div>');
    }).catch(function (err) {
      console.error(err);
    });
  });
  ...
  searchInput.on('keyup', function (e) {
    ...
    var activeClass = 'search__result--active';
    var current = search.querySelector('.' + activeClass);
    var items = search.querySelectorAll('.search__result-hero');
    var next = void 0;
    if (e.keyCode === 40 && current) {
      next = current.nextElementSibling || items[0];
    } else if (e.keyCode === 40) {
...
var _typeAheadHome = __webpack_require__(14);

var _typeAheadHome2 = _interopRequireDefault(_typeAheadHome);

var _productModal = __webpack_require__(12);

var _productModal2 = _interopRequireDefault(_productModal);

var _filtersSearch = __webpack_require__(11);

var _filtersSearch2 = _interopRequireDefault(_filtersSearch);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _typeAhead2.default)((0, _bling.$)(".search"));
(0, _typeAheadHome2.default)((0, _bling.$)(".search__hero"));
(0, _productModal2.default)();
(0, _filtersSearch2.default)();
